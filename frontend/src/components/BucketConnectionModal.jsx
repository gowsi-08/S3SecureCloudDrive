            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 placeholder-gray-500 bg-white font-medium"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="AKIA..."
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-mono text-gray-900 placeholder-gray-500 bg-white font-medium"
                />
                <p className="text-xs text-gray-500 mt-1">
